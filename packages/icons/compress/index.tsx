 ...
 * @Last Modified time: 2021-11-01 14:56:38
 */
...
export default defineComponent({
  ...
  render(): JSXNode {
    return (
      <svg viewBox="64 64 896 896" focusable="false" data-icon="compress" width="1em" height="1em" fill="currentColor" aria-hidden="true">
        <defs>
          <style></style>
        </defs>
