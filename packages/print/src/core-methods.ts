 ...
 * @Last Modified time: 2021-10-19 15:12:06
 */
    ...
    doPrint(__html__): void {
      ...
      LODOP.On_Return = (TaskID, Value) => {
        ...
        if (Value) {
          ...
          QmMessage.error(this.$t('qm.print.printError'));
        }
      };
    ...
    doExport(__html__): void {
      ...
      LODOP.On_Return = (TaskID, Value) => {
        ...
        if (Value) {
          ...
          QmMessage.error(this.$t('qm.print.exportError'));
        }
      };
